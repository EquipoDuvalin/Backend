...
public class ArticuloControllerTest {
  ...
  void add() throws Exception {
    ...
    response.andDo(print()).andExpect(status().isCreated())
        ...
        .andExpect(jsonPath("$.id_unidad", is(articuloOne.getUtilidad())))
        .andExpect(jsonPath("$.id_proveedor", is(articuloOne.getUtilidad())))
        ...
        .andExpect(jsonPath("$.punto", is(articuloOne.getPuntos())))
